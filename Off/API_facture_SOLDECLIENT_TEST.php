...
$resultats = $requete->fetchAll(); */
    ...
    $requete = $pdo->prepare("SELECT DET_NOMPAYEUR,DET_RESTANTDU  FROM cw_sync_facture WHERE DET_REFDETTE = :DET_REFDETTE");
...
if(count($resultats) > 0){
    ...
    $retour['message'] = "Voici le solde du client ".$resultats[0]['DET_NOMPAYEUR'];
    $retour['success'] = true; 
