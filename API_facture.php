...
<div class="container-fluid">
	<br>
	<div class="row">
		<div class="col-lg-12 text-center text-muted"><h2> Consulter toutes les factures </h2> </div>
	</div>
					  ...
					  <div class="col-8">
					    <div class="tab-content" id="nav-tabContent">
					      ...
					      <div class="tab-pane fade text-center text-muted" id="list-profiles" role="tabpanel" aria-labelledby="list-profile-list">
					      	<b>ETAPE</b>
					      	<ol>
					      	<li>Renseigner le nom du service se présentant sous cette forme : <br>Exemple : <b> "name" = "ListAllFactures"</b></li> 	
					      	<li>
					      		Aucun paramètres n'est requis pour lancer cette requête.
					      	</li>
					      </ol>
					  </div>
				...
				<table class="table table-borderless table-dark">
				  ...
				  <tbody>
				    ...
				    <tr>
				      ...
				      <!-- <td>Mark</td> -->
				      <!--  <td>Otto</td> -->
				      <td colspan="2" class="text-center text-muted">ListAllFactures</td>
				    </tr>
  ...
  <div class="modal-dialog modal-xl">
     <div class="container-fluid">
	    <div class="modal-content">
	     	 <img src="images/apercu/allFacture.png" height="500" width="100%" alt="Token">
	     <br>
